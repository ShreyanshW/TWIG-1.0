...
const struct {
  ...
  // Pick Sequence (Base 0°, Shoulder 30°, Elbow 240°)
  {{  0, 30, 240, 90, 0}, 1000, 0, "Approach object (gripper open)"},
  {{  0, 30, 200, 45, 0}, 800,  0, "Lower to object"},
  {{  0, 30, 200, 45, 90}, 500, 300, "Grab object (gripper closed)"},
  
  // Lift and Transport (Base 0° → 180°)
  {{ 30, 30, 60, 90,  75}, 1000, 0, "Lift and start moving"},
  {{ 60, 30, 45, 135, 75}, 800, 0, "First wrist flourish"},
  {{ 90, 30, 60, 45,  75}, 1000, 0, "Continue transport"},
  {{135,  0, 60, 90,  75}, 1200, 0, "Approach drop point"},
  
  // Place Sequence (Base 180°, Shoulder -60°, Elbow 50°)
  {{180, -30, 70, 60,  75}, 1000, 0, "Position for drop"},
  {{180, -30, 70, 90,  0}, 500, 500, "Release object (gripper open)"},
  
  // Return Home (Base 90°, Shoulder 30°, Elbow 30°)
  {{180,  0, 60, 90,  0}, 1000, 0, "Retract arm"},
